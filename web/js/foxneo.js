/*global require, FDM_Player_vars, $pdk */

require(['almond', 'jquery', 'underscore', 'polyfills', 'iframe', 'debug'], function (almond, $, _, polyfills, iframe, debug) {
    'use strict';
...
//        debug.checkForVersionChange('jQuery', jQueryApp, $);
            ...
            window.FoxNEO = window.$f = this;
            debug.log('FoxNEO', window.FoxNEO);
        })();
        //-------------------------------------------------------------------------------- initialization
